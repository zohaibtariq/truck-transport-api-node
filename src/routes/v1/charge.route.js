 ...
 * tags:
 *   name: Charges
 *   description: Charge management and retrieval
 */
 ...
 *     description: Only admins can create other charges.
 *     tags: [Charges]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Logged in charges can fetch only their own charge information. Only admins can fetch other charges.
 *     tags: [Charges]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in charges can only update their own information. Only admins can update other charges.
 *     tags: [Charges]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in charges can delete only themselves. Only admins can delete other charges.
 *     tags: [Charges]
 *     security:
 *       - bearerAuth: []
 *     parameters:
